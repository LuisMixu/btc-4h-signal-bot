"""
BTC AI-Score Strategy (4h) -- standalone signal notifier.

Reimplements the Pine Script indicator's composite score, entry/exit rules,
...
Pulls closed 4h candles for BTCUSDT (Bitget public API, no auth needed),
recomputes the same regime-adaptive score as btc-4h-ai-score-indicator.pine,
